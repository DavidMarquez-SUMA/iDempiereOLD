...
/****************FUNCION setC_DocType_ID CREADA POR P.S PARA TRANSFERENCIA ENTRE BANCOS DESDE EL ARCHIVO BANKTRANSFER.java*****************/
	public void setC_DocType_ID (int C_DocType_ID, boolean isReceipt)
	{
		/*setIsReceipt(isReceipt);
		String sql = "SELECT C_DocType_ID FROM C_DocType WHERE C_DocType_ID="+C_DocType_ID+" AND IsActive='Y' AND AD_Client_ID=? ORDER BY IsDefault DESC";
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
		{
...
/*			rs = pstmt.executeQuery();
	...
	protected boolean verifyDocType(MPaymentAllocate[] pAllocs)
	{
		...
		try
		{
			...
			//java.lang.System.out.println(paymentSO);
		}
		catch (Exception e)
		{
			log.log(Level.SEVERE, sql, e);
		...
		java.lang.System.out.println("isReceipt: "+isReceipt());	
...
*/
	...
	//	MOrgInfo counterOrgInfo = MOrgInfo.get(getCtx(), counterAD_Org_ID);
		...
		counter.setC_BPartner_ID(counterBP.getC_BPartner_ID());
			java.lang.System.out.println("hhhh");
