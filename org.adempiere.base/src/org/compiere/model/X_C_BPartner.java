...
// N
	...
	/*MODIFICACIONES CAMPOS SALDOS EN BS Y $ EN TERCEROS. PABLO SALAMANCA*/
	/** Set SUMA_Saldo_Bs.
	@param SUMA_Saldo_Bs 
	SUMA_Saldo_Bs 
  */
	...
	{
		set_Value (COLUMNNAME_SUMA_Saldo_Bs, SUMA_Saldo_Bs);
	}
	
	/** Get SUMA_Saldo_Bs.
		@return SUMA_Saldo_Bs
	  */
	public BigDecimal getSUMA_Saldo_Bs () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_SUMA_Saldo_Bs);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
  ...
  */
	...
	{
		set_Value (COLUMNNAME_SUMA_Saldo_US, SUMA_Saldo_US);
	}
	
	/** Get SUMA_Saldo_Us.
		@return SUMA_Saldo_Us
	  */
	public BigDecimal getSUMA_Saldo_US () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_SUMA_Saldo_US);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	/*FIN DE MODIFICACIONES PABLO SALAMANCA*/
	/** Set URL.
		@param URL 
