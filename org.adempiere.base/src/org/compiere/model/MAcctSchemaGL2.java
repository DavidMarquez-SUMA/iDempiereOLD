 ...
 */
public class MAcctSchemaGL2 extends X_C_InterOrg_Acct_SM
{
	 ...
	 *	@return defaults
	 */
	public static MAcctSchemaGL2 get (Properties ctx, int C_AcctSchema_ID)
	{
	...
	/**	Logger							*/
	protected static CLogger			s_log = CLogger.getCLogger(MAcctSchemaGL2.class);
	 ...
	 */
	public MAcctSchemaGL2 (Properties ctx, int C_AcctSchema_ID, String trxName)
	{
	 ...
	 *	@param trxName transaction
	 */
	public MAcctSchemaGL2 (Properties ctx, ResultSet rs, String trxName)
	{
