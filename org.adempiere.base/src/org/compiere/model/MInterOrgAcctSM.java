 ...
 */
public class MInterOrgAcctSM extends X_C_InterOrg_Acct_SM
{
	 ...
	 *	@return defaults
	 */
	public static MInterOrgAcctSM get (Properties ctx, int C_AcctSchema_ID, int AD_Org_ID_SM)
	{
		final String whereClause = "C_AcctSchema_ID=? and AD_Org_ID ="+AD_Org_ID_SM;
		//java.lang.System.out.println("final ORG: "+AD_Org_ID_SM);
		return new Query(ctx,I_C_InterOrg_Acct_SM.Table_Name,whereClause,null)
	...
	/**	Logger							*/
	protected static CLogger			s_log = CLogger.getCLogger(MInterOrgAcctSM.class);
	 ...
	 */
	public MInterOrgAcctSM (Properties ctx, int C_AcctSchema_ID, String trxName)
	{
	 ...
	 *	@param trxName transaction
	 */
	public MInterOrgAcctSM (Properties ctx, ResultSet rs, String trxName)
	{
