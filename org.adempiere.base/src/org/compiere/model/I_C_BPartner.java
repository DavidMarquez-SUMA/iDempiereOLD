...
public interface I_C_BPartner 
{
	...
	/*MODIFICACIONES PARA LOS CAMPOS DE SALDOS EN $ Y BS EN LA VENTANA TERCEROS PABLO SALAMANCA*/
	/** Column name SUMA_Saldo_Bs */
    public static final String COLUMNNAME_SUMA_Saldo_Bs = "SUMA_Saldo_Bs";

	/** Set SUMA_Saldo_Bs.
	  * SUMA_Saldo_Bs Monto de las Transacciones en moneda Bs.
	  */
	public void setSUMA_Saldo_Bs (BigDecimal SUMA_Saldo_Bs);

	
	/** Get SUMA_Saldo_Bs.
	  * SUMA_Saldo_Bs Mont de las transacciones Bs.
	  */
	public BigDecimal getSUMA_Saldo_Bs();
	
	/** Column name SUMA_Saldo_Us */
    public static final String COLUMNNAME_SUMA_Saldo_US = "SUMA_Saldo_US";

	/** Set SUMA_Saldo_Us.
	  * SUMA_Saldo_Us Monto de las Transacciones en moneda Us.
	  */
	public void setSUMA_Saldo_US (BigDecimal SUMA_Saldo_US);

	
	/** Get SUMA_Saldo_Us.
	  * SUMA_Saldo_Bs Mont de las transacciones Us.
	  */
	public BigDecimal getSUMA_Saldo_US();
	/*FIN MODIFICACIONES PARA LOS CAMPOS DE SALDOS EN $ Y BS EN LA VENTANA TERCEROS PABLO SALAMANCA*/
