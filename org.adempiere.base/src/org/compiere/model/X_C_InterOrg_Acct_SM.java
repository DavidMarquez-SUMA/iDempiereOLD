...
/** Generated Model for C_InterOrg_Acct_SM
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_C_InterOrg_Acct_SM extends PO implements I_C_InterOrg_Acct_SM, I_Persistent 
{
    ...
    public X_C_InterOrg_Acct_SM (Properties ctx, int C_InterOrg_Acct_SM_ID, String trxName)
    {
      super (ctx, C_InterOrg_Acct_SM_ID, trxName);
      /** if (C_InterOrg_Acct_SM_ID == 0)
        {
			setAD_OrgTo_ID (0);
    ...
    /** Load Constructor */
    public X_C_InterOrg_Acct_SM (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_InterOrg_Acct_SM[")
	...
	/** Set C_InterOrg_Acct_SM_UU.
		@param C_InterOrg_Acct_SM_UU C_InterOrg_Acct_SM_UU	  */
	public void setC_InterOrg_Acct_SM_UU (String C_InterOrg_Acct_SM_UU)
	{
		set_Value (COLUMNNAME_C_InterOrg_Acct_SM_UU, C_InterOrg_Acct_SM_UU);
	}

	/** Get C_InterOrg_Acct_SM_UU.
		@return C_InterOrg_Acct_SM_UU	  */
	public String getC_InterOrg_Acct_SM_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_InterOrg_Acct_SM_UU);
	}
