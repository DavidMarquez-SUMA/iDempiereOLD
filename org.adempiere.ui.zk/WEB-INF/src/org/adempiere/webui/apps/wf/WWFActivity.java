	...
	public int loadActivities()
	{
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				rowData.add(activity.getOrganization());//MODIFICADO POR PABLO SALAMANCA PARA MOSTRAR LA ORGANIZACION
				model.add(rowData);
		...
		String[] columns = new String[]{Msg.translate(Env.getCtx(), "Priority"),
				...
				Msg.translate(Env.getCtx(), "Organization")};//MODIFICADO POR PABLO SALAMANCA PARA MOSTRAR LA ORGANIZACION
				//Msg.translate(Env.getCtx(), "Summary")};
